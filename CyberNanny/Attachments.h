...
class _Attachments : public COleDispatchDriver
{
public:
	_Attachments(){} // Calls COleDispatchDriver default constructor
	_Attachments(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_Attachments(const _Attachments& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
