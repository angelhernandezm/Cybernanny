...
class Accounts : public COleDispatchDriver
{
public:
	Accounts(){} // Calls COleDispatchDriver default constructor
	Accounts(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Accounts(const Accounts& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
